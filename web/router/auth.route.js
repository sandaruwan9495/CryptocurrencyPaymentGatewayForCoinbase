...
router.post('/adminLogin', controllers.authController.adminLogin);
// router.get('/bitcoin-payment', controllers.authController.bitcoinPayment);
router.get('/bitcoin-payment', controllers.authController.requestFund);
